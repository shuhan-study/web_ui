# [ARCHIVED — DISCARDED DRAFT] P6 Deploy PRD

> **Status:** Discarded. Written by a mol-idea-to-plan intake polecat on 2026-04-20
> as output of a failed Path B run. Captured here for learning, not for execution.
>
> **Why discarded:** The polecat was supposed to scope a *stack bump* (Next 16 /
> React 19 / Tailwind 4). Because conversation context doesn't cross into polecat
> sessions, it guessed scope from the repo — and produced a deploy PRD instead.
> The intended P6 scope was different. See
> `archive/sessions/2026-04-20-p6-kickoff-path-b.md` for the full story.
>
> **Why keep it:** The *content* is actually useful — it surfaces the real
> P6-deploy blockers (SQLite-on-Vercel, `force-dynamic` missing, navbar gaps).
> Future P6 or P7 work may draw from this. Treat as reference, not plan.
>
> Original path: `web_ui/refinery/rig/.prd-reviews/p6-deploy/prd-draft.md`
>
> ---
